        ...
        <div className="grid gap-12 lg:grid-cols-5 lg:gap-8">
          <div className="lg:col-span-2">
            ...
            <p className="mt-6 max-w-sm text-sm leading-relaxed text-muted-foreground">
              Premium wood slat panels and curated interior decor. We believe in quality craftsmanship, sustainable materials and timeless design that enhances every space.
            </p>
