        ...
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          <div className="lg:pl-8">
            ...
            <p className="mt-6 text-lg leading-relaxed text-muted-foreground">
              Where Japanese minimalism meets Scandinavian functionality. Our collection embodies the perfect balance between warmth and simplicity, creating spaces that are both serene and welcoming.
            </p>
