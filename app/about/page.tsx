...
const values = [
  ...
  },
  {
    ...
    description:
      "We source our materials responsibly, work with FSC-certified suppliers, and design products built to last - reducing waste through longevity.",
  },
  {
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-6 text-lg leading-relaxed text-muted-foreground">
              ...
              of premium wood craftsmanship into modern homes across Europe and the UK.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
            ...
            <div>
              ...
              <div className="mt-6 space-y-4 text-muted-foreground">
                <p>
                  Our founder, Lena Bergstrom, grew up surrounded by the forests of Sweden. Her grandfather was a
                  carpenter who taught her that wood has a soul - every grain tells a story, every knot holds character.
                </p>
                <p>
